    ...
    <div class="d-flex" id="wrapper">
        ...
        <div class="border-end bg-white" id="sidebar-wrapper">
            ...
            <div class="list-group list-group-flush">
                ...
                <a class="list-group-item list-group-item-action list-group-item-light p-3 active" href="add-product.php">Add Product</a>
            </div>
        </div>
        <!-- content wrapper-->
                        ...
                        <div class="col">
                            ...
                            <form action="" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-floating mb-3">
                                    <input type="text" class="form-control" name="judul_produk" id="judul_produk" placeholder="judul_produk" required>
                                ...
                                <div class="form-floating mb-3">
                                    <div class="mb-3">
                                        <input class="form-control form-control-lg fs-6" type="file" name="gambar" id="gambar">
                                    </div>
                                </div>
                                <div class="text-center">
                                    <button class="btn btn-dark" type="submit" name="add-product">ADD PRODUCT</button>
                                </div>
                            </form>
                        </div>
                    </div>
