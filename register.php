            ...
            <div class="col-lg-6 col-md-6 col-sm-12 left">
                <div class="content mt-lg-4 mt-md-5 mt-sm-3">
                    ...
                    <form action="" method="POST"> 
                        <h3 class="text-center judul">SIGN UP</h3>
                        <p class="deskripsi mt-3 mb-4 text-center">See your growth and get<br>
                            consulting support!</p>
                        <div class="mb-3 mt-4">
                            <input type="text" style="padding: 0px 0px 0px 15px;" name="username" id="username" class="form-control form-control-sm" placeholder="Username" aria-describedby="emailHelp" required>
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            <input type="password" name="password2" id="password2" class="form-control form-control-sm" placeholder="Confirm Password" required>
                        </div>
                        ...
                        <button type="submit" name="register" id="register" class=" mb-3 center-block">SIGN UP</button>
                        <div class="text-center">
                            <p>
                                Have an account? <a href="login.php" class="link-page text-decoration-none other">Sign In</a>
                            </p>
                            <footer>
