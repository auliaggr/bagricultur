        ...
        <div class="row">
            <div class="col-lg-6 col-md-6 col-sm-12 left">
                <div class="content mt-lg-5 mt-md-5 mt-sm-3">
                    ...
                    <form action="" method=""> 
                        <h3 class="text-center judul mt-5">RESET PASSWORD</h3>
                        <p class="deskripsi mt-3 mb-4 text-center">Enter the registered email. We will send<br>
                            verification code to reset your password.</p>
                        <div class="mb-3 mt-4">
                            <input type="email" name="email" class="form-control form-control-sm" placeholder="Email" id="password" aria-describedby="emailHelp">
                        </div>
                        <button type="submit" name="submit" class=" mb-3 center-block">SEND</button>
                        <div class="text-center">
                            <p>
                                Back to <a href="login.php" class="link-page text-decoration-none other">Sign In</a>
                            </p>
                            <footer>
